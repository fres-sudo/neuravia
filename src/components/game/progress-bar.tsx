...
export const ProgressBar = () => {
	...
	return (
		<div className="mx-4 sm:mx-6 md:mx-8 lg:mx-12 xl:mx-16 2xl:mx-20 flex items-center gap-4 bg-white rounded-full px-8 py-4 shadow-lg border-4 border-gray-200">
			{/* Score Circle */}
			<div className="flex flex-col items-center flex-shrink-0">
				<div className="bg-green-400 text-white rounded-full w-16 h-16 flex items-center justify-center text-xl font-bold">
					{score}
				</div>
				<span className="text-sm font-semibold text-gray-700 mt-1">SCORE</span>
			</div>
