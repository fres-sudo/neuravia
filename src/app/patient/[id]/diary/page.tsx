              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2 text-red-600 bg-red-50 border border-red-200 rounded-md p-3">
                  ...
                  <span className="text-sm font-medium">
                    Be careful: once submitted and processed, you won’t be able to update this diary.
                  </span>
                </div>
                <div className="flex items-center gap-2 text-muted-foreground text-sm mt-1">
                  <BookOpen className="w-4 h-4" />
                  Week starting: <span className="font-medium">{weekStartStr}</span>
                </div>
              </div>
            </CardHeader>
                ...
                {fields.map((field) => (
                  <div key={field.key} className="space-y-4">
                    ...
                    <div className="flex justify-between text-sm text-muted-foreground">
                      ...
                      <span className="font-medium">Current: {responses[field.key]}</span>
